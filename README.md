...
Cutting a release is a manual `git tag` step — see [`RELEASING.md`](RELEASING.md) for the pre-flight checklist and what `release.yml` does automatically after the tag push.
