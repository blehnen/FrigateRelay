...
|---------|---------|--------|-------|
| .NET 10 SDK | **10.0.203** | [release-notes/10.0/10.0.7](https://github.com/dotnet/core/blob/main/release-notes/10.0/10.0.7/10.0.7.md) | Released 2026-04-21. Bundles runtime 10.0.7 (OOB security update). `global.json` version field must be `"10.0.203"` with `rollForward: latestFeature` per D4. |
