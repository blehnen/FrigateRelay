...
- [2026-05-07T16:05:01Z] Phase 14: Phase 14/v1.2.0 awaiting tag; Phases 15 (v1.2.1 hardening) + 16 (v1.3.0) scoped from issue triage 2026-05-07. ISSUES.md cull: 5 closed (ID-1/3/7 WONTFIX, ID-9 DONE, ID-17-dup DUPLICATE). 13 open issues bundled. Design doc at .shipyard/phases/15-and-16-issues-cleanup-design.md; ROADMAP extended with Phase 15+16 entries. Ready for /shipyard:plan 15. (ready)
- [2026-05-07T16:21:34Z] Phase 15: Planning Phase 15 (v1.2.1 hardening). Phase 14 status corrected: COMPLETE 2026-05-07 (v1.2.0 tag cut, deployed live). v1.2.0 verified via git tag -l. (planning)
- [2026-05-07T16:46:03Z] Phase 15: Phase 15 (v1.2.1) planned. 4 plans / 9 tasks / 1 wave (all parallel). PLAN-1.1 (StartupValidation hardening, 3 tasks, 11 net-new tests, TDD), PLAN-1.2 (ActionEntryTypeConverter, 1 task, 2 tests, TDD), PLAN-1.3 (CI hygiene, 3 tasks, non-TDD), PLAN-1.4 (Docker doc hygiene, 2 tasks, doc-only). Verifier verdict: PASS (3 advisory, 0 blocking). Critic verdict: CAUTION (PLAN-1.3 secret-scan scan-arg typo fixed inline; SHA resolution needs gh api two-step at build; CHANGELOG.md serialize last). Ready for /shipyard:build 15. (planned)
- [2026-05-07T16:49:18Z] Phase 15: Building Phase 15. Sequential dispatch (PLAN-1.4 -> 1.2 -> 1.3 -> 1.1) chosen over parallel: shared working tree means parallel dotnet builds would race on bin/obj output, and CHANGELOG.md is touched by all 4 plans. CHANGELOG edits per CRITIQUE.md C4 advisory: each builder makes its plan-specific entry, sequential dispatch makes the additive serialization safe. (building)
- [2026-05-07T17:33:15Z] Session ended during build (may need /shipyard:resume)
- [2026-05-07T17:34:11Z] Session ended during build (may need /shipyard:resume)
- [2026-05-07T18:28:06Z] Session ended during build (may need /shipyard:resume)
- [2026-05-07T18:28:42Z] Session ended during build (may need /shipyard:resume)
- [2026-05-07T18:28:50Z] Session ended during build (may need /shipyard:resume)
- [2026-05-07T18:33:31Z] Session ended during build (may need /shipyard:resume)
- [2026-05-07T18:33:58Z] Session ended during build (may need /shipyard:resume)
- [2026-05-07T18:38:49Z] Phase 15: Phase 15 (v1.2.1 hardening) build COMPLETE on feature/phase-15-v1.2.1. 10 plan commits + 1 review-followup. 146/146 Host tests pass (133 + 13 net-new). All 10 IDs closed. VERIFICATION PASS, AUDIT NO_CRITICAL, SIMPLIFICATION CLEAN, DOCUMENTATION GAPS_NON_BLOCKING (3 small operator-doc additions). Awaiting PR merge + operator tag-cut v1.2.1. (complete)
- [2026-05-07T21:31:05Z] Phase 15: v1.2.1 SHIPPED 2026-05-07. PR #45 merged at b294bb3; CHANGELOG promotion at c427b2b; v1.2.1 tag cut. release.yml completed SUCCESS (8m42s) — smoke gate green, multi-arch GHCR push complete (linux/amd64 + linux/arm64 to ghcr.io/blehnen/frigaterelay:1.2.1, :latest, :1). 151 Host tests passing (133 + 18 net-new across the full Phase 15 cycle). Phase 15 closed. Next: /shipyard:plan 16 for v1.3.0 (MetricsTags:KnownCameras + Task.Delay polling refactor + PluginRegistrar shape unification). (shipped)
- [2026-05-07T21:35:16Z] Phase 16: Planning Phase 16 (v1.3.0 minor release). Scope from .shipyard/phases/15-and-16-issues-cleanup-design.md and ROADMAP.md Phase 16 entry: #18 MetricsTags:KnownCameras config, #22 Task.Delay polling refactor, #30 PluginRegistrar HttpClient unification. v1.2.1 shipped 2026-05-07; v1.2.0 still live in operator deployment. Phase 15 must ship before Phase 16 (already met). (planning)
- [2026-05-07T22:02:12Z] Phase 16: Phase 16 (v1.3.0) planned. 3 plans / 8 tasks / 1 wave. PLAN-1.1 MetricsTagWriter+KnownCameras (#18, 3 tasks, TDD), PLAN-1.2 WaitForEntriesAsync refactor (#22, 2 tasks), PLAN-1.3 Registrar unification + CPAI backfill (#30, 3 tasks). Verifier verdict: PASS (1 WARN — CounterIncrementTests.cs + EventPumpSpanTests.cs shared between PLAN-1.1 and PLAN-1.2; sequential dispatch resolves). Critic verdict: READY. Builder pre-build verifications: baseline compile + 151 test count + RC-4 EnqueueAsync signature at CounterIncrementTests.cs:418-421. Ready for /shipyard:build 16. (planned)
- [2026-05-08T14:00:20Z] Phase ?: Building Phase 16 (v1.3.0). Sequential dispatch agent-mode: PLAN-1.1 -> 1.2 -> 1.3. Shared test files force sequential ordering. (building)
- [2026-05-08T15:08:20Z] Session ended during build (may need /shipyard:resume)
- [2026-05-08T15:11:07Z] Session ended during build (may need /shipyard:resume)
- [2026-05-08T15:58:44Z] Session ended during build (may need /shipyard:resume)
- [2026-05-08T16:53:59Z] Session ended during build (may need /shipyard:resume)
- [2026-05-08T18:26:14Z] Session ended during build (may need /shipyard:resume)
- [2026-05-08T21:33:08Z] Session ended during build (may need /shipyard:resume)
- [2026-05-08T21:36:29Z] Session ended during build (may need /shipyard:resume)
- [2026-05-08T21:38:10Z] Session ended during build (may need /shipyard:resume)
- [2026-05-08T22:38:03Z] Phase ?: Phase 16 (v1.3.0) build complete. 11 commits. 313 tests pass across 11 projects (151+3 Host, 8+5 CPAI, 16 Roboflow, 14 DOODS2, others unchanged). Quality gates: VERIFICATION PASS, AUDIT PASS_WITH_NOTES (3 advisory), SIMPLIFICATION MINOR_BLOAT (1 High deferred to Phase 17 — StaticOptionsMonitor extraction), DOCUMENTATION GAPS_NON_BLOCKING (5 recommendations all applied in commit 0d46303). Ready for /shipyard:ship to cut the v1.3.0 PR + tag. (complete)
- [2026-05-11T16:39:55Z] Phase 16: v1.3.0 SHIPPED 2026-05-11. PR #46 merged at 133d914; PR #47 (Dependabot WireMock.Net 2.4.0->2.5.0) merged at a925638; post-merge CodeRabbit fixes addressed in 58a500e + dfceff1 (StaticOptionsMonitor extraction, named-arg sweep, CapturingLogger thread-safety, MD040). 313 unit tests pass across 10 projects, 0 warnings. Next: operator cuts v1.3.0 tag (manual per CONTEXT-16 D9); release.yml auto-runs smoke + multi-arch GHCR push. (shipped)
